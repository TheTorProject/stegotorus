...
class payload_server
{
 public:
  unsigned int find_client_payload(payloads& pl, char* buf, int len, int type) = 0;

  int get_payload (payloads& pl, int contentType, int cap, char** buf, int* size) = 0;
